Welcome! In today's course, we will be working through taking a gradle spring boot application and converting it to use the 3musketeers patterns. In this scenario, we will cover the following topics:
